...
A3. 용신 선정 — 억부→조후→통관 순, 근거 필수:
  · 억부: 신약이면 인성·비겁이 용신, 신강이면 식상·재·관이 용신.
  · 조후 보정: 겨울(亥子丑월)·水왕 → 火(丙) / 여름(巳午未월)·火왕 → 水. 억부와 충돌하면 둘 다 제시(자평 vs 궁통보감).
  · 통관: 두 오행이 상극으로 팽팽하면 중간 오행(식상 등)이 통관 용신(土克水 → 金으로 土生金生水).
  · 🔴 반드시 "용신=○○, 근거=억부/조후/통관 중 무엇"을 밝힌다. 근거 없는 용신 금지.
