...
# ── 상품 ─────────────────────────────────────────────────────
PRODUCTS = {
    "single": {"name": "심화풀이 단건", "amount": 2900,
               "desc": "궁금한 주제 1개 심층 풀이"},
    "package": {"name": "심화풀이 패키지", "amount": 6900,
                "desc": "연애·재물·직업 3영역 심층 풀이"},
    "premium": {"name": "프리미엄 리포트", "amount": 9900,
                "desc": "전 영역 심층 풀이 + 소장용 PDF"},
}
